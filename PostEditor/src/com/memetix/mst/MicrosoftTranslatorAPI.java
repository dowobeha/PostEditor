...
public abstract class MicrosoftTranslatorAPI {
    ...
    protected static String retrieveString(final URL url) throws Exception {
    	try {
    		final String response = retrieveResponse(url);   System.err.println("Response:\t"+response);	 		
     ...
     * @throws Exception on error.
     */
    protected static List<Map<String,String>> retrieveListOfMaps(final URL url) throws Exception {
    	try {
    	    final String response = retrieveResponse(url);    System.err.println("Response:\t"+response);		
            return jsonToListOfMaps(response);
    	} catch (Exception ex) {
    		throw new Exception("[microsoft-translator-api] Error retrieving translation.", ex);
    	}
    }
    ...
    private static List<Map<String,String>> jsonToListOfMaps(final String inputString) throws Exception {
        final JSONArray jsonArr = (JSONArray)JSONValue.parse(inputString);
        List<Map<String,String>> list = new ArrayList<Map<String,String>>(jsonArr.size());
